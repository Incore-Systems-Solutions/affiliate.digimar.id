...
@section('meta')
   ...
   <!-- Meta Item -->
    <title>{{ $meta['meta'][$lang]['title'] ?? 'affiliate.digimar.id – Dapatkan Penghasilan dari Program Afiliasi Digimar' }}</title>
    <meta name="description" content="{{ $meta['meta'][$lang]['description'] ?? 'Gabung program afiliasi kami, bagikan tautan, dan hasilkan komisi dari setiap transaksi yang berasal dari referensi Anda.' }}">
    <meta name="keywords" content="{{ $meta['meta'][$lang]['keywords'] ?? 'program afiliasi, pemasaran afiliasi, penghasilan online, komisi penjualan, tautan afiliasi, digimar afiliasi' }}">
   <!-- Schema Item -->
    {{-- Schema Item --}}
